var routes = [
  ...
  // Right Panel pages
  {
    ...
    content: '\
      <div class="page">\
        <div class="navbar navbar-photo-browser navbar-style-1">\
  ...
  {
    path: '/payment-method/',
    componentUrl: './pages/payment-method.html',
  },
  {
    path: '/write-reviews/',
  ...
  {
    path: '/distributor/',
    componentUrl: './pages/distributor.html',
  },
  {
    path: '/edit-distributor/',
    componentUrl: './pages/edit-distributor.html',
  },
  {
    path: '/new-distributor/',
    componentUrl: './pages/new-distributor.html',
  },

  {
    path: '/brand/',
    componentUrl: './pages/brand.html',
  },
  {
    path: '/edit-brand/',
    componentUrl: './pages/edit-brand.html',
  },
  {
    path: '/new-brand/',
    componentUrl: './pages/new-brand.html',
  },

  {
    path: '/product-type/',
    componentUrl: './pages/product-type.html',
  },
  {
    path: '/edit-product-type/',
    componentUrl: './pages/edit-product-type.html',
  },
  {
